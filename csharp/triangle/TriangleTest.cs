...
public class TriangleTest
{
    ...
    [Fact]
    public void Degenerate_triangle_two_sides_equal_to_one_side()
    {
        Assert.True(Triangle.IsDegenerate(5, 5, 10));
    }

    [Fact]
    public void Degenerate_triangle_two_sides_not_equal_to_one_side()
    {
        Assert.False(Triangle.IsDegenerate(5, 5, 9));
    }
}